...
from tvm.relay.analysis import PipelineGraph

def run_module(mod, dname, data):
...
pl = [1, 2]
mods = PipelineGraph(mod["main"], pl)

data = np.full(dshape, 5).astype("float32")
out = run_module(mod, "data", data)

o1 = run_module(mods[0], "data", data)
o2 = run_module(mods[1], "x", o1)
o3 = run_module(mods[2], "x", o2)
