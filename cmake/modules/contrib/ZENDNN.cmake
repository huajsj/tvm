...
elseif(USE_ZENDNN STREQUAL "C_SRC")
	...
	link_directories("/scratch/staff/huaj/tvm/zendnn/ZenDNN/_out/lib")
	link_directories("/scratch/staff/huaj/tvm/zendnn/ZenDNN/aocl-linux-gcc-4.0/amd-blis/lib")
	link_directories("/scratch/staff/huaj/tvm/zendnn/ZenDNN/aocl-linux-gcc-4.0/amd-libm/lib")
	...
	#find_library(EXTERN_LIBRARY_ZENDNN zendnn)
	#list(APPEND TVM_RUNTIME_LINKER_LIBS ${EXTERN_LIBRARY_ZENDNN})
	list(APPEND TVM_RUNTIME_LINKER_LIBS "amdZenDNN")
	list(APPEND TVM_RUNTIME_LINKER_LIBS "blis-mt")
	list(APPEND TVM_RUNTIME_LINKER_LIBS "alm")
